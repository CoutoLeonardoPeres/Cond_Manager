...
class StatusChangeLogModel {
  StatusChangeLogModel({
    required this.id,
  ...
  factory StatusChangeLogModel.fromJson(Map<String, dynamic> json) {
    final author = json['changer'];
    return StatusChangeLogModel(
  ...
  StatusChangeLog toEntity() => StatusChangeLog(
        ...
        fromStatus: fromStatus != null
            ? TicketStatus.fromValue(fromStatus!).label
            : null,
        toStatus: TicketStatus.fromValue(toStatus).label,
