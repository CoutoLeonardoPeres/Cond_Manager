...
extension PreventivePermissions on UserProfile {
  bool canManagePreventiveIn(String condominiumId) {
  ...
  bool canDeletePreventiveIn(String condominiumId) {
    return permissions.canDeleteRecordsInCondominium(condominiumId);
  }

  bool get canCreatePreventivePlan {
    if (permissions.isAdmin || permissions.isManager || permissions.isAnalyst) {
