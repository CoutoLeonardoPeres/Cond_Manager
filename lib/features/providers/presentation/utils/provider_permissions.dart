...
extension ProviderPermissions on UserProfile {
  bool canManageProvidersIn(String condominiumId) {
  ...
  bool canDeleteProvidersIn(String condominiumId) {
    return permissions.canDeleteRecordsInCondominium(condominiumId);
  }

  bool get canCreateProvider {
    if (permissions.isAdmin || permissions.isManager || permissions.isAnalyst) {
